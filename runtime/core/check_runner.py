...
STEPS: tuple[Step, ...] = (
    ...
    Step("ol11-trpg-longrun-plan-check", redcap("ol11", "plan-check")),
    Step("ol11-trpg-longrun-plan-self-check", redcap("ol11", "self-check")),
...
PROFILE_STEPS: dict[str, tuple[str, ...] | None] = {
    ...
    "release": (
        ...
        "ol11-trpg-longrun-plan-check",
        "ol11-trpg-longrun-plan-self-check",
    ),
    "terminal": None,
}
