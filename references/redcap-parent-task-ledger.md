...
| P4-1 | parent boundary | 历史资产迁移真实 apply | deferred | P1 | file-level apply preflight 已建立，temp-copy apply rehearsal 已落地；下一步需在真实 throwaway worktree 中复验 alias/linkmap、docs catalog/receipt anchor 与回滚，再进入 main-tree 风险窗口 | 本轮 rehearsal 不移动/删除 main-tree 资产，不可冒充真实迁移 |
