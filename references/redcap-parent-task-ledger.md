...
| P4-1 | parent boundary | 历史资产迁移真实 apply | deferred | P1 | file-level apply preflight 已建立；下一步需在 throwaway worktree 执行真实 apply rehearsal、旧路径 alias/linkmap、receipt anchor 验证与回滚演练 | 本轮 preflight 不移动/删除资产，不可冒充真实迁移 |
