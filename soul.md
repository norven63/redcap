...
| 1 | `soul.md` | 搭档培养指南 + 复活协议 | ~180 行 |
| 2 | `CONTRIBUTING.md` | 自身开发规范 | ~550 行 ⚠️ 大文件 |
| 3 | `knowledge/lessons.md` | 经验库 | ~360 行 ⚠️ 大文件 |
| 4 | `knowledge/design-principles.md` | 元原则 P-1~P-5 | ~105 行 |
