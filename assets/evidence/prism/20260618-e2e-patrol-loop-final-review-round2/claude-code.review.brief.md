...
/Users/norven/workspace/AI Era/redcap/assets/evidence/prism/20260618-e2e-patrol-loop-final-review-round2/request.json
...

{
  ...
  "changed_reality": [
    ...
    "Prism review 校验器已新增占位文本门禁，非法占位 review fixture 会在 prism check 中失败，防止结构合法但内容无效的评审被合并。"
  ],
  "evidence": [
    {
      "kind": "diff",
    ...
    {
      "kind": "diff",
      "reference": "runtime/prism/bin/prism",
      "summary": "Prism review 校验新增占位文本和 concern/block 实质内容门禁。"
    },
    {
      "kind": "diff",
      "reference": "runtime/prism/examples/prism-review.invalid-placeholder.json",
      "summary": "非法占位 review 负向样例。"
    },
    {
      "kind": "test",
    ...
    },
    {
      ...
      "summary": "Prism 自检通过，包含占位 review 负向门禁。"
    },
    {
      "kind": "document",
  ...
  "known_constraints": [
    ...
    "评审内容不得使用暂不填写、先探索代码、待补充、TODO、TBD 或 placeholder 这类占位文本。",
