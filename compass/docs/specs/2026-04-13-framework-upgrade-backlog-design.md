...
- 当前焦点：`P4-27 R1 contract-mirror apply preflight for small public/internal subset`
- 当前焦点说明：P4-27 待推进：P4-26 已选择小范围 public/internal contract apply preflight 作为下一条安全切片；下一步仍只做预检，不得实施物理迁移、删除旧锚点、清理 raw evidence、关闭 release blocker 或进入正式发布。
...
| 阶段 31：发布准备小范围合同镜像 apply 预检 | 待推进 | P4-27 | 只做小范围 public/internal contract apply preflight，不直接进入物理迁移、删除、发布或 Layer A 产品裁决。 |
...
| P4-27 R1 contract-mirror apply preflight for small public/internal subset | 发布前路线与授权边界 | 待推进 | P0 | P4-27 待推进：按 P4-26 路线裁决，只做小范围 public/internal contract apply preflight；不得实施物理迁移、删除旧锚点、清理 raw evidence、关闭 release blocker 或进入正式发布。 |
