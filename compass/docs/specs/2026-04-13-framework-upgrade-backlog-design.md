...
- 当前焦点说明：正式发布 R1 的 control-plane apply 预检已完成：已把 P4-2s 的 dry-run 地图升级为 copy-first / alias-first apply 前置护栏；本项未复制、未移动、未删除旧 compass/references 锚点，未关闭 blocker，未执行发布。
