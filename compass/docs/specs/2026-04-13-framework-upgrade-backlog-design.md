...
- 当前焦点：`P4-12 R1 Prism report archive copy-first / alias-first migration planning`
- 当前焦点说明：P4-12 待推进：P4-11 已选定下一条安全小切片；下一步只做 Prism report archive copy-first / alias-first 迁移规划、清单、别名草案、回滚与验证方案，不执行物理迁移或证据清理。
...
| 阶段 16：发布准备 Prism report archive 迁移规划 | 待推进 | P4-12 | 正式发布动作之前，只规划 Prism 报告归档的 copy-first / alias-first 清单、旧锚点 alias、回滚和验证方案；当前仍不执行物理复制、移动、删除或证据清理。 |
...
| P4-12 R1 Prism report archive copy-first / alias-first migration planning | 发布前路线与授权边界 | 待推进 | P0 | 基于 P4-11 路线评审，产出 Prism report archive 的 plan-only 迁移清单、旧锚点 alias 草案、回滚方案与验证清单；本项不执行物理复制、移动、删除或 raw evidence cleanup。 |
