...
- 当前焦点说明：P4-5 已完成：正式发布 R1 的 Prism evidence apply 预检已把 P4-3e 的 dry-run 证据边界升级为 copy-first / alias-first apply 前置护栏；本项未移动、未删除、未清理 prism 证据，不关闭 blocker，不执行发布。
