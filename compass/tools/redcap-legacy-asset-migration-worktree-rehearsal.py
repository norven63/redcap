...
def main() -> int:
    ...
    parser.add_argument("--check-stored-result-only", action="store_true", help="Validate the stored worktree rehearsal receipt without re-running live rehearsal.")
    ...
    if args.check_stored_result_only:
        ...
        print(
            "LEGACY_ASSET_MIGRATION_WORKTREE_REHEARSAL_STORED_OK "
