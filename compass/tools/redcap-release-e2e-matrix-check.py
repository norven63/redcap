...
def main() -> int:
    ...
    if not isinstance(environments, list) or len(environments) < 6:
        fail("matrix must cover source, clean install, npm pack, historical cleanup, evolution harvest, and external machine")
    ...
    required_ids = {
        ...
        "evolution-harvest-signal-release-gate",
